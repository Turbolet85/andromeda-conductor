I have enough research basis. The searches confirm the dominant 2025-2026 pattern for this category: status indicators using a tight functional color tier (green pass / amber hold / red fail), "is everything okay?" answered by a single status element, progressive disclosure behind deliberate interaction, and the literal go/no-go poll + built-in hold + paused-count convention from mission control. This aligns directly with the prior brand picks. I have what I need to synthesize the candidates.
