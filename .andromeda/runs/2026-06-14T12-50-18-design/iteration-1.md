...
- Drop shadows: **none.** `box-shadow` is permitted only as a single `0 0 0 2px var(--focus)` focus-ring inset on keyboard focus (a ring, not an elevation shadow).
...
@theme {
  ...
  --space-sm: 8px; --space-md: 12px; --space-lg: 20px;
