The amendment history file does not exist (expected — sidecars are created lazily on first amendment). I now have all the inputs to produce the security extract.
