...
[2026-09-09-port-occupier-test-hygiene] Port-occupier test hygiene — the fault crate's port-occupier test green under the shared-process runner, free of its process-global observability dependency
   ↓
[2026-09-10-live-pulse-in-lane-scenario-round] Live-Pulse in-lane scenario round — P-067, P-072 and P-079 each yielding a non-blocked live verdict, with journal and runs.db evidence per scenario
   ↓
