...
//! [`error_trace_request`], [`exception_trace_request`], [`latency_trace_request`]) and log records
//! with controlled `SeverityNumber` ([`severity_logs_request`]) — shipped over tonic gRPC
