...
pub use canary::{CANARY_SERVICE_NAME, CANARY_STORM_COUNT, Preflight, canary_spec, canary_storm_seed,
...
pub use lifecycle::{AUTO_RESOLVE_IDLE_SECONDS, LifecycleObservation, LifecycleVerdict,
    attribute_by_liveness, evaluate_lifecycle, probe_resolve_lifecycle, select_resolve_target};
